 ...
 * will still return NULL). If the new context is installed successfully, the return value is a pointer to the specified context.
 *
 ...
 */
GContext *InstallContext(GWindow *window, int type);

/** Returns the context of the specified window, this should never return NULL. */
GContext *GetContext(GWindow *window);

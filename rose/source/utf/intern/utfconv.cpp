...
size_t count_utf8_from_16 ( const wchar_t *string16 ) {
        int i;
        size_t count = 0;
        wchar_t u = 0;
        if ( !string16 ) {
...
size_t count_utf16_from_8 ( const char *string8 ) {
        size_t count = 0;
        char u;
        char type = 0;
        unsigned int u32 = 0;
...
int conv_utf16_to_8 ( const wchar_t *in16 , char *out8 , size_t size8 ) {
...
int conv_utf8_to_16 ( const char *in8 , wchar_t *out16 , size_t size16 ) {
        char u;
        char type = 0;
        unsigned int u32 = 0;
...
char *alloc_utf8_from_16 ( const wchar_t *in16 , size_t add ) {
        size_t bsize = count_utf8_from_16 ( in16 );
        char *out8 = NULL;
        if ( !bsize ) {
                return NULL;
        }
        out8 = ( char * ) MEM_mallocN ( sizeof ( char ) * ( bsize + add ) , __func__ );
        conv_utf16_to_8 ( in16 , out8 , bsize );
        return out8;
}

wchar_t *alloc_utf16_from_8 ( const char *in8 , size_t add ) {
        size_t bsize = count_utf16_from_8 ( in8 );
        wchar_t *out16 = NULL;
        if ( !bsize ) {
                return NULL;
        }
        out16 = ( wchar_t * ) MEM_mallocN ( sizeof ( wchar_t ) * ( bsize + add ) , __func__ );
        conv_utf8_to_16 ( in8 , out16 , bsize );
        return out16;
}

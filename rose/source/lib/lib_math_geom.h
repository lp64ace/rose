 ...
 */
	...
	ROSE_INLINE void mul_sh_fl ( float r [ 9 ] , float f );
	...
	ROSE_INLINE void vec_fac_to_sh ( float r [ 9 ] , const float v [ 3 ] , float f );
	ROSE_INLINE void madd_sh_shfl ( float r [ 9 ] , const float sh [ 9 ] , float f );
	 ...
	 */
	ROSE_INLINE float axis_dominant_v3_max ( int *r_axis_a ,
					     int *r_axis_b ,
	 ...
	 */
	ROSE_INLINE int poly_to_tri_count ( int poly_count , int corner_count );
	 ...
	 */
	ROSE_INLINE float shell_angle_to_dist ( float angle );
	/**
	...
	#include "intern/lib_math_geom_inline.cc"

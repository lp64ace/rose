...
#define BM_elem_flag_test(ele, hflag) _mesh_elem_flag_test(&(ele)->Head, hflag)
#define BM_elem_flag_test_bool(ele, hflag) _mesh_elem_flag_test_bool(&(ele)->Head, hflag)
#define BM_elem_flag_enable(ele, hflag) _mesh_elem_flag_enable(&(ele)->Head, hflag)
#define BM_elem_flag_disable(ele, hflag) _mesh_elem_flag_disable(&(ele)->Head, hflag)
#define BM_elem_flag_set(ele, hflag, val) _mesh_elem_flag_set(&(ele)->Head, hflag, val)
#define BM_elem_flag_toggle(ele, hflag) _mesh_elem_flag_toggle(&(ele)->Head, hflag)
#define BM_elem_flag_merge(ele_a, ele_b) _mesh_elem_flag_merge(&(ele_a)->Head, &(ele_b)->Head)
#define BM_elem_flag_merge_ex(ele_a, ele_b, hflag_and) _mesh_elem_flag_merge_ex(&(ele_a)->Head, &(ele_b)->Head, hflag_and)
#define BM_elem_flag_merge_into(ele, ele_a, ele_b) _mesh_elem_flag_merge_into(&(ele)->Head, &(ele_a)->Head, &(ele_b)->Head)

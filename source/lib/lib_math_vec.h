...
extern "C" {
        ...
        inline void copy_v2_uchar ( unsigned char r [ 2 ] , unsigned char a );
        inline void copy_v3_uchar ( unsigned char r [ 3 ] , unsigned char a );
        inline void copy_v4_uchar ( unsigned char r [ 4 ] , unsigned char a );
         ...
         * \endcode
         */
        inline float mul_project_m4_v3_zfac ( const float mat [ 4 ][ 4 ] ,
                                               const float co [ 3 ] ) ATTR_WARN_UNUSED_RESULT;
        /**
         * Has the effect of #mul_m3_v3(), on a single axis.
         */
        inline float dot_m3_v3_row_x ( const float M [ 3 ][ 3 ] , const float a [ 3 ] ) ATTR_WARN_UNUSED_RESULT;
        inline float dot_m3_v3_row_y ( const float M [ 3 ][ 3 ] , const float a [ 3 ] ) ATTR_WARN_UNUSED_RESULT;
        inline float dot_m3_v3_row_z ( const float M [ 3 ][ 3 ] , const float a [ 3 ] ) ATTR_WARN_UNUSED_RESULT;
        /**
         * Has the effect of #mul_mat3_m4_v3(), on a single axis.
         * (no adding translation)
         */
        inline float dot_m4_v3_row_x ( const float M [ 4 ][ 4 ] , const float a [ 3 ] ) ATTR_WARN_UNUSED_RESULT;
        inline float dot_m4_v3_row_y ( const float M [ 4 ][ 4 ] , const float a [ 3 ] ) ATTR_WARN_UNUSED_RESULT;
        inline float dot_m4_v3_row_z ( const float M [ 4 ][ 4 ] , const float a [ 3 ] ) ATTR_WARN_UNUSED_RESULT;
        ...
        inline float dot_v2v2 ( const float a [ 2 ] , const float b [ 2 ] ) ATTR_WARN_UNUSED_RESULT;
        inline double dot_v2v2_db ( const double a [ 2 ] , const double b [ 2 ] ) ATTR_WARN_UNUSED_RESULT;
        inline float dot_v3v3 ( const float a [ 3 ] , const float b [ 3 ] ) ATTR_WARN_UNUSED_RESULT;
        inline float dot_v3v3v3 ( const float p [ 3 ] ,
                                   const float a [ 3 ] ,
                                   const float b [ 3 ] ) ATTR_WARN_UNUSED_RESULT;
        inline float dot_v4v4 ( const float a [ 4 ] , const float b [ 4 ] ) ATTR_WARN_UNUSED_RESULT;

        inline double dot_v3db_v3fl ( const double a [ 3 ] , const float b [ 3 ] ) ATTR_WARN_UNUSED_RESULT;

        inline double dot_v3v3_db ( const double a [ 3 ] , const double b [ 3 ] ) ATTR_WARN_UNUSED_RESULT;

        inline float cross_v2v2 ( const float a [ 2 ] , const float b [ 2 ] ) ATTR_WARN_UNUSED_RESULT;
        inline double cross_v2v2_db ( const double a [ 2 ] , const double b [ 2 ] ) ATTR_WARN_UNUSED_RESULT;
        ...
        inline float len_squared_v2 ( const float v [ 2 ] ) ATTR_WARN_UNUSED_RESULT;
        inline float len_squared_v3 ( const float v [ 3 ] ) ATTR_WARN_UNUSED_RESULT;
        inline float len_squared_v4 ( const float v [ 4 ] ) ATTR_WARN_UNUSED_RESULT;
        inline float len_manhattan_v2 ( const float v [ 2 ] ) ATTR_WARN_UNUSED_RESULT;
        inline int len_manhattan_v2_int ( const int v [ 2 ] ) ATTR_WARN_UNUSED_RESULT;
        inline float len_manhattan_v3 ( const float v [ 3 ] ) ATTR_WARN_UNUSED_RESULT;
        inline float len_v2 ( const float v [ 2 ] ) ATTR_WARN_UNUSED_RESULT;
        inline double len_v2_db ( const double v [ 2 ] ) ATTR_WARN_UNUSED_RESULT;
        inline float len_v2v2 ( const float v1 [ 2 ] , const float v2 [ 2 ] ) ATTR_WARN_UNUSED_RESULT;
        inline double len_v2v2_db ( const double v1 [ 2 ] , const double v2 [ 2 ] ) ATTR_WARN_UNUSED_RESULT;
        inline float len_v2v2_int ( const int v1 [ 2 ] , const int v2 [ 2 ] );
        inline float len_squared_v2v2 ( const float a [ 2 ] , const float b [ 2 ] ) ATTR_WARN_UNUSED_RESULT;
        inline double len_squared_v2v2_db ( const double a [ 2 ] , const double b [ 2 ] ) ATTR_WARN_UNUSED_RESULT;
        inline float len_squared_v3v3 ( const float a [ 3 ] , const float b [ 3 ] ) ATTR_WARN_UNUSED_RESULT;
        inline float len_squared_v4v4 ( const float a [ 4 ] , const float b [ 4 ] ) ATTR_WARN_UNUSED_RESULT;
        inline float len_manhattan_v2v2 ( const float a [ 2 ] , const float b [ 2 ] ) ATTR_WARN_UNUSED_RESULT;
        inline int len_manhattan_v2v2_int ( const int a [ 2 ] , const int b [ 2 ] ) ATTR_WARN_UNUSED_RESULT;
        inline float len_manhattan_v3v3 ( const float a [ 3 ] , const float b [ 3 ] ) ATTR_WARN_UNUSED_RESULT;
        inline float len_v3 ( const float a [ 3 ] ) ATTR_WARN_UNUSED_RESULT;
        inline float len_v3v3 ( const float a [ 3 ] , const float b [ 3 ] ) ATTR_WARN_UNUSED_RESULT;

        inline double len_v3_db ( const double a [ 3 ] ) ATTR_WARN_UNUSED_RESULT;
        inline double len_squared_v3_db ( const double v [ 3 ] ) ATTR_WARN_UNUSED_RESULT;
        inline float normalize_v2_length ( float n [ 2 ] , float unit_length );
        /**
         * \note any vectors containing `nan` will be zeroed out.
         */
        inline float normalize_v2_v2_length ( float r [ 2 ] , const float a [ 2 ] , float unit_length );
        inline float normalize_v3_length ( float n [ 3 ] , float unit_length );
        /**
         * \note any vectors containing `nan` will be zeroed out.
         */
        inline float normalize_v3_v3_length ( float r [ 3 ] , const float a [ 3 ] , float unit_length );
        inline double normalize_v3_length_db ( double n [ 3 ] , double unit_length );
        inline double normalize_v3_v3_length_db ( double r [ 3 ] , const double a [ 3 ] , double unit_length );
        ...
        inline bool is_zero_v2 ( const float v [ 2 ] ) ATTR_WARN_UNUSED_RESULT;
        inline bool is_zero_v3 ( const float v [ 3 ] ) ATTR_WARN_UNUSED_RESULT;
        inline bool is_zero_v4 ( const float v [ 4 ] ) ATTR_WARN_UNUSED_RESULT;

        inline bool is_zero_v2_db ( const double v [ 2 ] ) ATTR_WARN_UNUSED_RESULT;
        inline bool is_zero_v3_db ( const double v [ 3 ] ) ATTR_WARN_UNUSED_RESULT;
        inline bool is_zero_v4_db ( const double v [ 4 ] ) ATTR_WARN_UNUSED_RESULT;
        ...
        inline bool is_one_v3 ( const float v [ 3 ] ) ATTR_WARN_UNUSED_RESULT;

        inline bool equals_v2v2 ( const float v1 [ 2 ] , const float v2 [ 2 ] ) ATTR_WARN_UNUSED_RESULT;
        inline bool equals_v3v3 ( const float v1 [ 3 ] , const float v2 [ 3 ] ) ATTR_WARN_UNUSED_RESULT;
        inline bool equals_v4v4 ( const float v1 [ 4 ] , const float v2 [ 4 ] ) ATTR_WARN_UNUSED_RESULT;

        inline bool equals_v2v2_int ( const int v1 [ 2 ] , const int v2 [ 2 ] ) ATTR_WARN_UNUSED_RESULT;
        inline bool equals_v3v3_int ( const int v1 [ 3 ] , const int v2 [ 3 ] ) ATTR_WARN_UNUSED_RESULT;
        inline bool equals_v4v4_int ( const int v1 [ 4 ] , const int v2 [ 4 ] ) ATTR_WARN_UNUSED_RESULT;

        inline bool compare_v2v2 ( const float v1 [ 2 ] ,
                                    const float v2 [ 2 ] ,
                                    float limit ) ATTR_WARN_UNUSED_RESULT;
        inline bool compare_v3v3 ( const float v1 [ 3 ] ,
                                    const float v2 [ 3 ] ,
                                    float limit ) ATTR_WARN_UNUSED_RESULT;
        inline bool compare_v4v4 ( const float v1 [ 4 ] ,
                                    const float v2 [ 4 ] ,
                                    float limit ) ATTR_WARN_UNUSED_RESULT;

        inline bool compare_v2v2_relative ( const float v1 [ 2 ] , const float v2 [ 2 ] , float limit , int max_ulps )
                ATTR_WARN_UNUSED_RESULT;
        inline bool compare_v3v3_relative ( const float v1 [ 3 ] , const float v2 [ 3 ] , float limit , int max_ulps )
                ATTR_WARN_UNUSED_RESULT;
        inline bool compare_v4v4_relative ( const float v1 [ 4 ] , const float v2 [ 4 ] , float limit , int max_ulps )
                ATTR_WARN_UNUSED_RESULT;

        inline bool compare_len_v3v3 ( const float v1 [ 3 ] ,
                                        const float v2 [ 3 ] ,
                                        float limit ) ATTR_WARN_UNUSED_RESULT;

        inline bool compare_size_v3v3 ( const float v1 [ 3 ] ,
                                         const float v2 [ 3 ] ,
                                         float limit ) ATTR_WARN_UNUSED_RESULT;
         ...
         * (looking from 'l1' -> 'l2').
         */
        inline float line_point_side_v2 ( const float l1 [ 2 ] ,
                                           const float l2 [ 2 ] ,
...
#define print_vn_id(v, n) print_vn(STRINGIFY(v), v, n)
        ...
        inline void clamp_v2 ( float vec [ 2 ] , float min , float max );
        inline void clamp_v3 ( float vec [ 3 ] , float min , float max );
        inline void clamp_v4 ( float vec [ 4 ] , float min , float max );

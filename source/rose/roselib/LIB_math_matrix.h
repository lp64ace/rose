 ...
 */
void LIB_space_transform_from_matrices(struct SpaceTransform *data, const float local[4][4], const float target[4][4]);
/**
 ...
 */
void LIB_space_transform_global_from_matrices(struct SpaceTransform *data, const float local[4][4], const float target[4][4]);
void LIB_space_transform_apply(const struct SpaceTransform *data, float co[3]);
void LIB_space_transform_invert(const struct SpaceTransform *data, float co[3]);

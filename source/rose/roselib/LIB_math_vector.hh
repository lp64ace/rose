#ifndef LIB_MATH_VECTOR_HH
#define LIB_MATH_VECTOR_HH
 ...
 */
template<typename T, int Size> [[nodiscard]] inline bool almost_equal_relative(const VecBase<T, Size> &a, const VecBase<T, Size> &b, const T &epsilon_factor) {
 ...
 */
template<typename T, int Size> [[nodiscard]] inline VecBase<T, Size> sign(const VecBase<T, Size> &a) {
	VecBase<T, Size> result;
	for (int i = 0; i < Size; i++) {
...
template<typename T, int Size> [[nodiscard]] inline VecBase<T, Size> min(const VecBase<T, Size> &a, const VecBase<T, Size> &b) {
	VecBase<T, Size> result;
	for (int i = 0; i < Size; i++) {
...
template<typename T, int Size> [[nodiscard]] inline VecBase<T, Size> max(const VecBase<T, Size> &a, const VecBase<T, Size> &b) {
	VecBase<T, Size> result;
	for (int i = 0; i < Size; i++) {
		result[i] = a[i] > b[i] ? a[i] : b[i];
	}
...
template<typename T, int Size> [[nodiscard]] inline VecBase<T, Size> clamp(const VecBase<T, Size> &a, const VecBase<T, Size> &min, const VecBase<T, Size> &max) {
...
template<typename T, int Size> [[nodiscard]] inline VecBase<T, Size> clamp(const VecBase<T, Size> &a, const T &min, const T &max) {
	VecBase<T, Size> result = a;
	for (int i = 0; i < Size; i++) {
...
template<typename T, int Size> [[nodiscard]] inline VecBase<T, Size> step(const VecBase<T, Size> &edge, const VecBase<T, Size> &value) {
...
template<typename T, int Size> [[nodiscard]] inline VecBase<T, Size> step(const T &edge, const VecBase<T, Size> &value) {
	VecBase<T, Size> result = value;
	for (int i = 0; i < Size; i++) {
...
template<typename T, int Size> [[nodiscard]] inline VecBase<T, Size> mod(const VecBase<T, Size> &a, const VecBase<T, Size> &b) {
	VecBase<T, Size> result;
	for (int i = 0; i < Size; i++) {
		BLI_assert(b[i] != 0);
...
template<typename T, int Size> [[nodiscard]] inline VecBase<T, Size> mod(const VecBase<T, Size> &a, const T &b) {
	BLI_assert(b != 0);
	VecBase<T, Size> result;
	for (int i = 0; i < Size; i++) {
 ...
 */
template<typename T, int Size> [[nodiscard]] inline VecBase<T, Size> safe_mod(const VecBase<T, Size> &a, const VecBase<T, Size> &b) {
	VecBase<T, Size> result;
	for (int i = 0; i < Size; i++) {
 ...
 * Safe version of mod(a, b) that returns 0 if b is equal to 0.
 */
template<typename T, int Size> [[nodiscard]] inline VecBase<T, Size> safe_mod(const VecBase<T, Size> &a, const T &b) {
	if (b == 0) {
...
template<typename T, int Size> [[nodiscard]] inline VecBase<T, Size> pow(const VecBase<T, Size> &x, const T &y) {
	VecBase<T, Size> result;
	for (int i = 0; i < Size; i++) {
...
template<typename T, int Size> [[nodiscard]] inline VecBase<T, Size> pow(const VecBase<T, Size> &x, const VecBase<T, Size> &y) {
	VecBase<T, Size> result;
	for (int i = 0; i < Size; i++) {
...
/** Per-element square. */
template<typename T, int Size> [[nodiscard]] inline VecBase<T, Size> square(const VecBase<T, Size> &a) {
	VecBase<T, Size> result;
	for (int i = 0; i < Size; i++) {
 ...
 */
template<typename T, int Size> [[nodiscard]] inline VecBase<T, Size> ceil_to_multiple(const VecBase<T, Size> &a, const VecBase<T, Size> &b) {
	VecBase<T, Size> result;
	for (int i = 0; i < Size; i++) {
		BLI_assert(a[i] >= 0);
		BLI_assert(b[i] > 0);
 ...
 * It is undefined if \a a is negative or \b b is not strictly positive.
 */
template<typename T, int Size> [[nodiscard]] inline VecBase<T, Size> divide_ceil(const VecBase<T, Size> &a, const VecBase<T, Size> &b) {
	VecBase<T, Size> result;
	for (int i = 0; i < Size; i++) {
		BLI_assert(a[i] >= 0);
		BLI_assert(b[i] > 0);
...
template<typename T, int Size> inline void min_max(const VecBase<T, Size> &vector, VecBase<T, Size> &min, VecBase<T, Size> &max) {
 ...
 */
template<typename T, int Size> [[nodiscard]] inline VecBase<T, Size> safe_divide(const VecBase<T, Size> &a, const VecBase<T, Size> &b) {
	VecBase<T, Size> result;
	for (int i = 0; i < Size; i++) {
 ...
 * Returns 0 if denominator is exactly equal to 0.
 */
template<typename T, int Size> [[nodiscard]] inline VecBase<T, Size> safe_divide(const VecBase<T, Size> &a, const T &b) {
	return (b != 0) ? a / b : VecBase<T, Size>(0.0f);
}

template<typename T, int Size> [[nodiscard]] inline VecBase<T, Size> floor(const VecBase<T, Size> &a) {
	VecBase<T, Size> result;
	for (int i = 0; i < Size; i++) {
...
template<typename T, int Size> [[nodiscard]] inline VecBase<T, Size> round(const VecBase<T, Size> &a) {
	VecBase<T, Size> result;
	for (int i = 0; i < Size; i++) {
...
template<typename T, int Size> [[nodiscard]] inline VecBase<T, Size> ceil(const VecBase<T, Size> &a) {
	VecBase<T, Size> result;
	for (int i = 0; i < Size; i++) {
 ...
 */
template<typename T, int Size> [[nodiscard]] inline VecBase<T, Size> sqrt(const VecBase<T, Size> &a) {
	VecBase<T, Size> result;
	for (int i = 0; i < Size; i++) {
 ...
 */
template<typename T, int Size> [[nodiscard]] inline VecBase<T, Size> safe_sqrt(const VecBase<T, Size> &a) {
	VecBase<T, Size> result;
	for (int i = 0; i < Size; i++) {
 ...
 */
template<typename T, int Size> [[nodiscard]] inline VecBase<T, Size> safe_rcp(const VecBase<T, Size> &a) {
	VecBase<T, Size> result;
	for (int i = 0; i < Size; i++) {
...
template<typename T, int Size> [[nodiscard]] inline VecBase<T, Size> fract(const VecBase<T, Size> &a) {
	VecBase<T, Size> result;
	for (int i = 0; i < Size; i++) {
 ...
 */
template<typename T, int Size> [[nodiscard]] inline T dot(const VecBase<T, Size> &a, const VecBase<T, Size> &b) {
	T result = a[0] * b[0];
...
template<typename T, int Size> [[nodiscard]] inline bool is_unit_scale(const VecBase<T, Size> &v) {
	...
	return (!(math::abs(test_unit - T(1)) >= AssertUnitEpsilon<T>::value) || !(math::abs(test_unit) >= AssertUnitEpsilon<T>::value));
}

template<typename T, int Size> [[nodiscard]] inline T distance_manhattan(const VecBase<T, Size> &a, const VecBase<T, Size> &b) {
	return length_manhattan(a - b);
}

template<typename T, int Size> [[nodiscard]] inline T distance_squared(const VecBase<T, Size> &a, const VecBase<T, Size> &b) {
	return length_squared(a - b);
}

template<typename T, int Size> [[nodiscard]] inline T distance(const VecBase<T, Size> &a, const VecBase<T, Size> &b) {
	return length(a - b);
}

template<typename T, int Size> [[nodiscard]] inline VecBase<T, Size> reflect(const VecBase<T, Size> &incident, const VecBase<T, Size> &normal) {
	BLI_assert(is_unit_scale(normal));
	return incident - 2.0 * dot(normal, incident) * normal;
}

template<typename T, int Size> [[nodiscard]] inline VecBase<T, Size> refract(const VecBase<T, Size> &incident, const VecBase<T, Size> &normal, const T &eta) {
 ...
 */
template<typename T, int Size> [[nodiscard]] inline VecBase<T, Size> project(const VecBase<T, Size> &p, const VecBase<T, Size> &v_proj) {
	if (is_zero(v_proj)) {
		return VecBase<T, Size>(0.0f);
	}
...
template<typename T, int Size> [[nodiscard]] inline VecBase<T, Size> normalize_and_get_length(const VecBase<T, Size> &v, T &out_length) {
...
template<typename T, int Size> [[nodiscard]] inline VecBase<T, Size> normalize(const VecBase<T, Size> &v) {
	T len;
 ...
 * normalized.
 * \note Rose 3D space uses right handedness: \a a = thumb, \a b = index, return = middle.
 */
template<typename T> [[nodiscard]] inline VecBase<T, 3> cross(const VecBase<T, 3> &a, const VecBase<T, 3> &b) {
 ...
 */
[[nodiscard]] inline VecBase<float, 3> cross_high_precision(const VecBase<float, 3> &a, const VecBase<float, 3> &b) {
	return {float(double(a.y) * double(b.z) - double(a.z) * double(b.y)), float(double(a.z) * double(b.x) - double(a.x) * double(b.z)), float(double(a.x) * double(b.y) - double(a.y) * double(b.x))};
}
 ...
 */
template<typename T> [[nodiscard]] inline VecBase<T, 3> cross_tri(const VecBase<T, 3> &v1, const VecBase<T, 3> &v2, const VecBase<T, 3> &v3) {
 ...
 */
template<typename T> [[nodiscard]] inline VecBase<T, 3> normal_tri(const VecBase<T, 3> &v1, const VecBase<T, 3> &v2, const VecBase<T, 3> &v3) {
 ...
 */
template<typename T, typename FactorT, int Size> [[nodiscard]] inline VecBase<T, Size> interpolate(const VecBase<T, Size> &a, const VecBase<T, Size> &b, const FactorT &t) {
	return a * (1 - t) + b * t;
}
 ...
 */
template<typename T, int Size> [[nodiscard]] inline VecBase<T, Size> midpoint(const VecBase<T, Size> &a, const VecBase<T, Size> &b) {
	return (a + b) * 0.5;
}
 ...
 */
template<typename T, int Size> [[nodiscard]] inline VecBase<T, Size> faceforward(const VecBase<T, Size> &vector, const VecBase<T, Size> &incident, const VecBase<T, Size> &reference) {
 ...
 */
template<typename T, int Size> [[nodiscard]] inline bool is_equal(const VecBase<T, Size> &a, const VecBase<T, Size> &b, const T epsilon = T(0)) {
	for (int i = 0; i < Size; i++) {
 ...
 */
template<typename T, int Size> [[nodiscard]] inline bool is_zero(const VecBase<T, Size> &a, const T epsilon = T(0)) {
	for (int i = 0; i < Size; i++) {
 ...
 */
template<typename T, int Size> [[nodiscard]] inline bool is_unit(const VecBase<T, Size> &a, const T epsilon = T(10) * std::numeric_limits<T>::epsilon()) {

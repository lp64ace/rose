#ifndef LIB_VECTOR_SET_SLOTS_HH
#define LIB_VECTOR_SET_SLOTS_HH

/** \file
 *
 * This file contains slot types that are supposed to be used with rose::VectorSet.
 *
...
public:
	 ...
	 */
	template<typename ForwardKey, typename IsEqual> bool contains(const ForwardKey &key, const IsEqual &is_equal, uint64_t /*hash*/, const Key *keys) const {
		if (state_ >= 0) {

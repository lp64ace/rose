#ifndef LIB_MULTI_VALUE_MAP_HH
#define LIB_MULTI_VALUE_MAP_HH

/**
 * A `rose::MultiValueMap<Key, Value>` is an unordered associative container that stores
 * key-value pairs. It is different from `rose::Map` in that it can store multiple values for
...
public:
	...
	template<typename ForwardKey, typename ForwardValue> void add_as(ForwardKey &&key, ForwardValue &&value) {
	...
	ROSE_STRUCT_EQUALITY_OPERATORS_1(MultiValueMap, map_)
};

}  // namespace rose

#endif // LIB_MULTI_VALUE_MAP_HH

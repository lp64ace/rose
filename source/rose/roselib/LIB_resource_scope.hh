#ifndef LIB_RESOURCE_SCOPE_HH
#define LIB_RESOURCE_SCOPE_HH

/* SPDX-FileCopyrightText: 2023 Rose Authors
 *
...
public:
	...
	~ResourceScope() {
		for (size_t i = resources_.size(); i--;) {

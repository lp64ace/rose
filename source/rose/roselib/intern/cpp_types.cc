...
ROSE_CPP_TYPE_MAKE(rose::float2, CPPTypeFlags::BasicType)
ROSE_CPP_TYPE_MAKE(rose::float3, CPPTypeFlags::BasicType)
...
ROSE_CPP_TYPE_MAKE(rose::int2, CPPTypeFlags::BasicType)
...
void register_cpp_types() {
	...
	ROSE_CPP_TYPE_REGISTER(rose::float2);
	ROSE_CPP_TYPE_REGISTER(rose::float3);

	ROSE_CPP_TYPE_REGISTER(int8_t);
	ROSE_CPP_TYPE_REGISTER(int16_t);
	ROSE_CPP_TYPE_REGISTER(int32_t);
	ROSE_CPP_TYPE_REGISTER(rose::int2);

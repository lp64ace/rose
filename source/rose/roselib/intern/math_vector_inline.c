...
MINLINE void invert_v2(float r[2]) {
	ROSE_assert(!ELEM(0.0f, r[0], r[1]));
	r[0] = 1.0f / r[0];
	r[1] = 1.0f / r[1];
}

MINLINE void invert_v3(float r[3]) {
	ROSE_assert(!ELEM(0.0f, r[0], r[1], r[2]));
	r[0] = 1.0f / r[0];
	r[1] = 1.0f / r[1];
	r[2] = 1.0f / r[2];
}
...
MINLINE bool compare_v3v3(const float v1[3], const float v2[3], const float limit) {
	return (compare_ff(v1[0], v2[0], limit) && compare_ff(v1[1], v2[1], limit) && compare_ff(v1[2], v2[2], limit));
}
...
MINLINE bool compare_v2v2_relative(const float v1[2], const float v2[2], const float limit, const int max_ulps) {
	return (compare_ff_relative(v1[0], v2[0], limit, max_ulps) && compare_ff_relative(v1[1], v2[1], limit, max_ulps));
}
...
MINLINE bool compare_v4v4_relative(const float v1[4], const float v2[4], const float limit, const int max_ulps) {
	return (compare_ff_relative(v1[0], v2[0], limit, max_ulps) && compare_ff_relative(v1[1], v2[1], limit, max_ulps) &&
			compare_ff_relative(v1[2], v2[2], limit, max_ulps) && compare_ff_relative(v1[3], v2[3], limit, max_ulps));
}

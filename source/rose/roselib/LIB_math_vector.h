...
MINLINE bool compare_v2v2(const float v1[2], const float v2[2], float limit);
MINLINE bool compare_v3v3(const float v1[3], const float v2[3], float limit);
MINLINE bool compare_v4v4(const float v1[4], const float v2[4], float limit);
...
MINLINE bool compare_len_v3v3(const float v1[3], const float v2[3], float limit);

MINLINE bool compare_size_v3v3(const float v1[3], const float v2[3], float limit);
...
double dot_vn_vn(const float *array_src_a, const float *array_src_b, int size);

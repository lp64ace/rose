#ifndef LIB_COMPILER_CHECKTYPE_H
#define LIB_COMPILER_CHECKTYPE_H
...
#	define CHECK_TYPE_INLINE(val, type) (void)((void)(((type)0) != (0 ? (val) : ((type)0))), _Generic((val), type: 0, const type: 0))
#else
...
#endif	// LIB_COMPILER_CHECKTYPE_H

...
void LIB_ghash_reserve(GHash *hash, uint reserve);
...
void LIB_ghash_clear_ex(GHash *hash, GHashKeyFreeFP keyfreefp, GHashValFreeFP valfreefp, uint reserve);
...
uint LIB_ghash_len(const GHash *hash);
...
ROSE_INLINE void *LIB_ghashIterator_getKey(GHashIterator *iter) {
	return ((struct _gh_Entry *)iter->curEntry)->key;
}
ROSE_INLINE void *LIB_ghashIterator_getValue(GHashIterator *iter) {
	return ((struct _gh_Entry *)iter->curEntry)->val;
}
ROSE_INLINE void **LIB_ghashIterator_getValue_p(GHashIterator *iter) {
	return &((struct _gh_Entry *)iter->curEntry)->val;
}
...
GHash *LIB_ghash_ptr_new_ex(const char *info, uint nentries_reserve);
GHash *LIB_ghash_ptr_new(const char *info);

GHash *LIB_ghash_str_new_ex(const char *info, uint nentries_reserve);
GHash *LIB_ghash_str_new(const char *info);

GSet *LIB_gset_ptr_new_ex(const char *info, uint nentries_reserve);
GSet *LIB_gset_ptr_new(const char *info);

GSet *LIB_gset_str_new_ex(const char *info, uint nentries_reserve);

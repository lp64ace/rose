#ifndef LIB_RANDOM_ACCESS_ITERATOR_MIXIN_HH
#define LIB_RANDOM_ACCESS_ITERATOR_MIXIN_HH
...
public:
	...
	auto &iter_prop_mutable() {
		...
		return const_cast<std::remove_const_t<std::remove_reference_t<decltype(const_iter_prop)>> &>(const_iter_prop);
	}
};

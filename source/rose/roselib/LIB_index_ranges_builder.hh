#ifndef LIB_INDEX_RANGES_BUILDER_HH
#define LIB_INDEX_RANGES_BUILDER_HH
...
public:
	...
	bool add_range(const T start, const T end) {
		...
		ROSE_assert(!is_new_range || this->size() < this->capacity());
...
#endif	// LIB_INDEX_RANGES_BUILDER_HH

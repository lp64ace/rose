#ifndef LIB_ENUMERABLE_THREAD_SPECIFIC_HH
#define LIB_ENUMERABLE_THREAD_SPECIFIC_HH
...
public:
	...
	template<typename F> EnumerableThreadSpecific(F initializer) : initializer_([=](void *buffer) { new (buffer) T(initializer()); }) {
	}
...
#endif	// LIB_ENUMERABLE_THREAD_SPECIFIC_HH

#ifndef LIB_MATH_COLOR_H
#define LIB_MATH_COLOR_H
...
/* YCbCr */
#define ROSE_YCC_ITU_BT601 0
#define ROSE_YCC_ITU_BT709 1
#define ROSE_YCC_JFIF_0_255 2

/* YUV */
#define ROSE_YUV_ITU_BT601 0
#define ROSE_YUV_ITU_BT709 1
...
ROSE_INLINE unsigned short to_srgb_table_lookup(float f);
...
ROSE_INLINE int compare_rgb_uchar(const unsigned char col_a[3], const unsigned char col_b[3], int limit);
...
ROSE_INLINE void rgba_uchar_args_set(unsigned char col[4], unsigned char r, unsigned char g, unsigned char b, unsigned char a);
ROSE_INLINE void rgba_float_args_set(float col[4], float r, float g, float b, float a);
ROSE_INLINE void rgba_uchar_args_test_set(unsigned char col[4], unsigned char r, unsigned char g, unsigned char b, unsigned char a);
ROSE_INLINE void cpack_cpy_3ub(unsigned char r_col[3], unsigned int pack);

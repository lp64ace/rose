...
#	define ROSE_ASSERT_UNIT_EPSILON 0.0002f
#	define ROSE_ASSERT_UNIT_EPSILON_DB 0.0002
/**
...
#	define ROSE_ASSERT_ZERO_M3(m) ROSE_assert(dot_vn_vn((const float *)m, (const float *)m, 9) != 0.0);

#	define ROSE_ASSERT_ZERO_M4(m) ROSE_assert(dot_vn_vn((const float *)m, (const float *)m, 16) != 0.0);
#	define ROSE_ASSERT_UNIT_M3(m) \
		{ \
			ROSE_ASSERT_UNIT_V3((m)[0]); \
			ROSE_ASSERT_UNIT_V3((m)[1]); \
			ROSE_ASSERT_UNIT_V3((m)[2]); \
		} \
		(void)0
#else
#	define ROSE_ASSERT_UNIT_V2(v) (void)(v)
#	define ROSE_ASSERT_UNIT_V3(v) (void)(v)
#	define ROSE_ASSERT_UNIT_V3_DB(v) (void)(v)
#	define ROSE_ASSERT_UNIT_QUAT(v) (void)(v)
#	define ROSE_ASSERT_ZERO_M3(m) (void)(m)
#	define ROSE_ASSERT_ZERO_M4(m) (void)(m)
#	define ROSE_ASSERT_UNIT_M3(m) (void)(m)
#endif

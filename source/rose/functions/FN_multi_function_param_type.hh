...
public:
	...
	ROSE_STRUCT_EQUALITY_OPERATORS_2(ParamType, interface_type_, data_type_)
};
...
inline ParamType::ParamType(InterfaceType interface_type, DataType data_type) : interface_type_(interface_type), data_type_(data_type) {
}

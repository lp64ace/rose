...
public:
	...
	ROSE_STRUCT_EQUALITY_OPERATORS_3(InstructionCursor, type_, instruction_, branch_output_)
};
...
private:
	...
	InitState find_initialization_state_before_instruction(const Instruction &target_instruction, const Variable &variable) const;
};
...
inline InstructionCursor::InstructionCursor(CallInstruction &instruction) : type_(Call), instruction_(&instruction) {
}

inline InstructionCursor::InstructionCursor(DestructInstruction &instruction) : type_(Destruct), instruction_(&instruction) {
}

inline InstructionCursor::InstructionCursor(BranchInstruction &instruction, bool branch_output) : type_(Branch), instruction_(&instruction), branch_output_(branch_output) {
}

inline InstructionCursor::InstructionCursor(DummyInstruction &instruction) : type_(Dummy), instruction_(&instruction) {
}
...
template<typename T, typename... Args> inline const MultiFunction &Procedure::construct_function(Args &&...args) {

...
public:
	...
	const Signature &signature() const {
		ROSE_assert(signature_ref_ != nullptr);
...
inline ParamsBuilder::ParamsBuilder(const MultiFunction &fn, const IndexMask *mask) : ParamsBuilder(fn.signature(), *mask) {
}

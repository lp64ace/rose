...
public:
	...
	ROSE_STRUCT_EQUALITY_OPERATORS_2(DataType, category_, type_)
...
inline DataType::DataType(Category category, const CPPType &type) : category_(category), type_(&type) {
}

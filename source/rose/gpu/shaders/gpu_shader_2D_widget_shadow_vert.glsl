...
/* 2 bits for corner */
/* Attention! Not the same order as in UI_interface.h! Ordered by drawing order. */
...
void main() {
	/* NOTE(Metal): Declaring constant array in function scope to avoid increasing local shader memory pressure. */

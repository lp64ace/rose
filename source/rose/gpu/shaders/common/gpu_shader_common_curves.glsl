...
void curves_vector_mixed(float factor,
						 ...
						 vec3 end_slopes,
						 out vec3 result) {
	curves_vector(vector, curve_map, layer, range_minimums, range_dividers, start_slopes, end_slopes, result);
...
void curves_float_mixed(float factor,
						...
						float end_slope,
						out float result) {
	curves_float(value, curve_map, layer, range_minimum, range_divider, start_slope, end_slope, result);

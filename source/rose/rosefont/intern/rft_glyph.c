 ...
 */
static GlyphRFT *rft_glyph_cache_find_glyph(const GlyphCacheRFT *gc, uint charcode, uint8_t subpixel) {
 ...
 */
static GlyphRFT *rft_glyph_cache_add_glyph(FontRFT *font, GlyphCacheRFT *gc, FT_GlyphSlot glyph, uint charcode, FT_UInt glyph_index, uint8_t subpixel) {
	...
	if (glyph->format == FT_GLYPH_FORMAT_BITMAP) {
		...
		g->bitmap = (uchar *)(MEM_mallocN((size_t)(buffer_size), "glyph bitmap"));
 ...
 */
static const UnicodeBlock *rft_charcode_to_unicode_block(const uint charcode) {
	if (charcode < 0x80) {
...
static int rft_charcode_to_coverage_bit(uint charcode) {
	int coverage_bit = -1;
 ...
 */
static FT_UInt rft_glyph_index_from_charcode(FontRFT **font, const uint charcode) {
 ...
 */
static FT_GlyphSlot rft_glyph_render(FontRFT *settings_font, FontRFT *glyph_font, FT_UInt glyph_index, uint charcode, uint8_t subpixel, int fixed_width, bool outline_only) {
...
static GlyphRFT *rft_glyph_ensure_ex(FontRFT *font, GlyphCacheRFT *gc, const uint charcode, uint8_t subpixel) {
...
GlyphRFT *rft_glyph_ensure(FontRFT *font, GlyphCacheRFT *gc, const uint charcode) {
...
static void rft_texture_draw(GlyphRFT *g, const uchar color[4], const int glyph_size[2], const int x1, const int y1, const int x2, const int y2) {
	...
	copy_v4_v4_uchar((uchar *)(GPU_vertbuf_raw_step(&g_batch.col_step)), color);
...
static void rft_texture5_draw(GlyphRFT *g, const uchar color_in[4], const int x1, const int y1, const int x2, const int y2) {
...
static void rft_texture3_draw(GlyphRFT *g, const uchar color_in[4], const int x1, const int y1, const int x2, const int y2) {
	int glyph_size_flag[2];

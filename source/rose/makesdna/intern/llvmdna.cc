...
int main(int argc, const char **argv) {
	...
	auto Executor = clang::tooling::createExecutorFromCommandLineArgs(argc = newArgv.size(), newArgv.data(), ToolTemplateCategory);
	...
	if (fout) {
		...
		fprintf(fout, " * Do not edit manually this is auto generated by #makesdna executable in llvmdna.cc.\n");
		fprintf(fout, " *\n");
		fprintf(fout, " * This file verifies the offsets and sizes of each structure field according to the \n");
		fprintf(fout, " * generated SDNA.\n");
		fprintf(fout, " */\n");
		fprintf(fout, "\n");

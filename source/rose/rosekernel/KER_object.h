...
struct Object *KER_object_add_for_data(struct Main *main, struct Scene *scene, int type, const char *name, struct ID *data);
...
void KER_object_rot_to_mat3(struct Object *object, float r_mat[3][3]);

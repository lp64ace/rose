 ...
 */
bool CustomData_mesh_has_free(const struct CustomData *data);
...
void *CustomData_add_layer_anonymous(struct CustomData *data, eCustomDataType type, eCDAllocType alloctype, int totelem, const AnonymousAttributeIDHandle *anonymous_id);
const void *CustomData_add_layer_anonymous_with_data(struct CustomData *data, eCustomDataType type, const AnonymousAttributeIDHandle *anonymous_id, int totelem, void *layer_data, const ImplicitSharingInfoHandle *sharing_info);
...
void CustomData_mesh_copy_data(const struct CustomData *source, struct CustomData *dest, void *src_block, void **dest_block);
void CustomData_mesh_copy_data_exclude_by_type(const struct CustomData *source, struct CustomData *dest, void *src_block, void **dest_block, eCustomDataMask mask_exclude);
...
void CustomData_mesh_set_default(struct CustomData *data, void **block);
void CustomData_mesh_free_block(struct CustomData *data, void **block);
void CustomData_mesh_alloc_block(struct CustomData *data, void **block);

/**
 * Same as #CustomData_mesh_free_block but zero the memory rather than freeing.
 */
void CustomData_mesh_free_block_data(struct CustomData *data, void *block);
void CustomData_mesh_free_block_data_exclude_by_type(struct CustomData *data, void *block, eCustomDataMask mask_exclude);
...
int CustomData_name_max_length_calc(rose::StringRef name);

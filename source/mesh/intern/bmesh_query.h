...
ROSE_INLINE bool BM_edge_in_loop ( const BMEdge *e , const BMLoop *l ) ATTR_WARN_UNUSED_RESULT ATTR_NONNULL ( );

ROSE_INLINE bool BM_vert_in_edge ( const BMEdge *e , const BMVert *v ) ATTR_WARN_UNUSED_RESULT ATTR_NONNULL ( );
ROSE_INLINE bool BM_verts_in_edge ( const BMVert *v1 , const BMVert *v2 , const BMEdge *e ) ATTR_WARN_UNUSED_RESULT ATTR_NONNULL ( );
...
ROSE_INLINE BMVert *BM_edge_other_vert ( BMEdge *e , const BMVert *v ) ATTR_WARN_UNUSED_RESULT ATTR_NONNULL ( );
...
/**
* Only #BMEdge.Loop access us needed, however when we want the first visible loop,
...
bool BM_vert_pair_share_face_check_cb ( BMVert *v_a ,
                                        ...
                                        void *user_data ) ATTR_WARN_UNUSED_RESULT ATTR_NONNULL ( 1 , 2 , 3 );
...
ROSE_INLINE bool BM_edge_is_wire ( const BMEdge *e ) ATTR_WARN_UNUSED_RESULT ATTR_NONNULL ( );
...
ROSE_INLINE bool BM_edge_is_manifold ( const BMEdge *e ) ATTR_WARN_UNUSED_RESULT ATTR_NONNULL ( );
bool BM_vert_is_boundary ( const BMVert *v ) ATTR_WARN_UNUSED_RESULT ATTR_NONNULL ( );
ROSE_INLINE bool BM_edge_is_boundary ( const BMEdge *e ) ATTR_WARN_UNUSED_RESULT ATTR_NONNULL ( );
ROSE_INLINE bool BM_edge_is_contiguous ( const BMEdge *e ) ATTR_WARN_UNUSED_RESULT ATTR_NONNULL ( );
...
ROSE_INLINE bool BM_loop_is_adjacent ( const BMLoop *l_a , const BMLoop *l_b ) ATTR_WARN_UNUSED_RESULT ATTR_NONNULL ( );

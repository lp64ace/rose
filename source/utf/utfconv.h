...
* \param out8 utf-8 string to store the conversion.
...
#define UTF16_ENCODE(in8str) { wchar_t *in8str##_16 = alloc_utf16_from_8((const char *)in8str, 0)
#define UTF16_UN_ENCODE(in8str) MEM_freeN(in8str##_16); }
